...
import com.psh.board.dto.AnswerForm;
import com.psh.board.dto.MemberForm;
import com.psh.board.dto.QuestionForm;
...
import com.psh.board.service.AnswerService;
import com.psh.board.service.MemberService;
import com.psh.board.service.QuestionService;
...
//			bindingResult.reject("idRegFail", "아이디 등록 중 에러가 발생했습니다.");
	...
	public String questionLike(@PathVariable("id") Integer id, Principal principal) {
		...
		SiteMember siteMember = memberService.getMember(principal.getName());//현재 로그인중인 유저의 정보(객체) 가져오기
